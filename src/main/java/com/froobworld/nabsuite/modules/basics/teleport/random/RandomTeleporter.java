...
public class RandomTeleporter {
    ...
    private Location generateRandomLocation(World world) {
        ...
        int offsetX = (random.nextBoolean() ? -1 : 1) * (worldSettings.minorRadiusX.get() + random.nextInt(worldSettings.majorRadiusX.get() - worldSettings.minorRadiusX.get()));
        int offsetZ = (random.nextBoolean() ? -1 : 1) * (worldSettings.minorRadiusZ.get() + random.nextInt(worldSettings.majorRadiusZ.get() - worldSettings.minorRadiusZ.get()));
